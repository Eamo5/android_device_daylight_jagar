...
# jagar fastboot packages flash super.img directly, so keep PRODUCT_OUT/super.img
# on the default/brunch build path instead of requiring a manual `m superimage`.
BOARD_BUILD_SUPER_IMAGE_BY_DEFAULT := true
BOARD_USES_METADATA_PARTITION := true

# Partitions (Dynamic)
# Match stock jagar main_a/main_b group naming and per-slot max.
...
# RIL
# Jagar stock properties indicate a Wi-Fi/tablet SKU. Keep the vendor RIL
# service disabled until modem support is confirmed from stock manifests/blobs.
